                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('customer.update') }}" id="myForm"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="customer_image" class="form-control"
                                            type="file" id="image">
                                    </div>
                                </div>
                                <!-- end row -->
            ...
            $('#myForm').validate({
                ...
                messages: {
                    ...
                    mobile_no: {
                        ...
                        minlength: 'Please Enter 10 Digits Correctly',
                        maxlength: 'Please Enter 10 Digits Correctly',
                        digits: 'Please Enter Numeric Characters',
                    },
                    email: {
